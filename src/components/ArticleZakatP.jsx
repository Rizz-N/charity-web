    ...
    <>
      <article className=" mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 font-sans text-gray-800">
        ...
        <div className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-700 prose-strong:text-gray-900 prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline">
          ...
          <h2>Niat Zakat Penghasilan</h2>
          {/* Gambar dengan responsive dan alt text yang baik untuk SEO */}
          <div className="my-6 flex justify-center">
            <img
              src={niatZakat}
              alt="Teks bacaan niat zakat penghasilan dalam bahasa Arab dan latin beserta artinya"
              className="w-full max-w-md h-auto rounded-lg shadow-md border border-gray-200"
              loading="lazy"
            />
          </div>
          <p className="text-sm text-gray-500 text-center -mt-4">
            Bacaan Niat Zakat Penghasilan: "Nawaitu an ukhrija zakatal maali 'an
            maali fardhan lillahi ta'ala"
          </p>
        </div>
      </article>
      <PanduanZakat />
