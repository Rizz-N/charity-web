      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white border border-slate-100 rounded-3xl shadow-lg p-5 md:p-8 h-fit sticky top-24">
          ...
          <Link
            ...
            className="w-full mt-3 inline-block text-center bg-linear-to-r from-blue-500 to-blue-700 py-2 hover:bg-blue-500 transition-colors duration-300 text-white font-medium"
          >
