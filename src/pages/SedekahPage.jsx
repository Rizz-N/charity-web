...
const SedekahPage = () => {
  const filterData = data.filter((items) => items.type === "sedekah");
            ...
            <div>
              ...
              <div className="mt-5 px-4 md:px-10 flex flex-col md:flex-row-reverse gap-8">
                ...
                <div className="space-y-5 text-justify text-slate-700 leading-relaxed text-sm md:text-lg flex-1">
                  <p>
                    Tidak semua orang memiliki kesempatan untuk menikmati hidup
                    dengan tenang. Di saat sebagian dari kita dapat makan dengan
                    layak, tidur dengan nyaman, dan menjalani hari tanpa rasa
                    takut, ada banyak saudara di luar sana yang harus berjuang
                    hanya untuk bertahan hingga esok hari.
                  </p>

                  <p>
                    Ada anak-anak yang menahan lapar demi melihat ibunya tetap
                    tersenyum. Ada orang tua yang menyembunyikan lelahnya agar
                    keluarganya tetap merasa kuat. Dan ada banyak harapan kecil
                    yang perlahan memudar karena keadaan yang tidak berpihak.
                  </p>

                  <p>
                    Mereka bukan sekadar cerita yang lewat di layar ponsel kita.
                    Mereka adalah manusia yang memiliki mimpi, harapan, dan
                    keinginan sederhana untuk hidup lebih baik.
                  </p>
                  ...
                  <p>
                    ...
                    menghadirkan harapan bagi mereka yang hampir kehilangan
                    alasan untuk percaya bahwa dunia masih peduli. Setiap
                    bantuan yang Anda berikan adalah bukti bahwa masih ada hati
                    yang mau menguatkan dan menemani perjuangan mereka.
                  </p>

                  <p>
                    Mungkin bagi kita itu hanya sebagian kecil rezeki. Namun
                    bagi mereka, bantuan itu bisa menjadi makanan untuk
                    keluarga, biaya sekolah anak, atau bahkan alasan untuk tetap
                    bertahan menghadapi hidup.
                  </p>

                  <p className="italic font-medium text-slate-800">
                    “Kebaikan sekecil apa pun tidak akan pernah sia-sia, karena
                    selalu ada hati yang tersentuh dan kehidupan yang berubah
                    karenanya.”
                  </p>
