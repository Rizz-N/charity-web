      ...
      <div className="mt-5 px-10 flex flex-col md:flex-row-reverse gap-5 ">
        ...
        <div className="space-y-5 text-justify text-slate-700 leading-relaxed md:text-lg">
          <p>
            ...
            saudara di luar sana yang harus berjuang hanya untuk bertahan hingga
            esok hari.
          </p>
          ...
          <p>
            Mereka bukan sekadar cerita yang lewat di layar ponsel kita. Mereka
            adalah manusia yang memiliki mimpi, harapan, dan keinginan sederhana
          ...
          <p>
            ...
            menghadirkan harapan bagi mereka yang hampir kehilangan alasan untuk
            percaya bahwa dunia masih peduli. Setiap bantuan yang Anda berikan
            adalah bukti bahwa masih ada hati yang mau menguatkan dan menemani
            perjuangan mereka.
          </p>
